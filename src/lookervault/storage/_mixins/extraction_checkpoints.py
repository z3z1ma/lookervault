"""Extraction checkpoint operations for storage mixin."""
...
from lookervault.storage.models import Checkpoint
from lookervault.utils import transaction_rollback


class ExtractionCheckpointsMixin:
    """Mixin providing extraction checkpoint operations.

    This mixin handles checkpoint creation, updates, and retrieval for
    tracking extraction progress and enabling resume functionality.
    """

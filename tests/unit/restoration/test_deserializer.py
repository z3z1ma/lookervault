...
class TestFilterReadOnlyFields:
    """Test filtering of read-only fields."""

    def test_filter_common_metadata_fields(self, deserializer, sample_dashboard_data):
